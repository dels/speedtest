...
test('adjust days in getTodayDate', () => {
    ...
    const config = cliDefault("2021-12-23", "18:00")
...
test('testing sime edge cases ', () => {
    ...
    let config
    config = cliDefault("2021-09-09", "09:09")
    ...
    config = cliDefault("2021-10-10", "10:10")
