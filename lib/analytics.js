...
import { readJsonFiles, lastMeasureWithinLastDays, longerBreakRequired } from './measures.js'
...
export function measurementNowWouldComplyGermanComplianceReport(cli, measures){
    ...
    if(longerBreakRequired(cli, measures)){
        if(cli.flags.verbose){
            console.log("we are about to take the sixth measure today. we need to have a break of at least 3 hours.")
        }
        return false
    }
    /*
